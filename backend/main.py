...
def _migrate_existing_schema():
    ...
    migrations: list[tuple[str, str, str]] = [
        ...
        ("users", "years_exp",      "ALTER TABLE users ADD COLUMN years_exp INTEGER"),
        ("users", "salary",         "ALTER TABLE users ADD COLUMN salary INTEGER"),
        ("users", "notice_period",  "ALTER TABLE users ADD COLUMN notice_period INTEGER"),
        ("users", "linkedin_session_json", "ALTER TABLE users ADD COLUMN linkedin_session_json TEXT"),
        ("users", "linkedin_session_updated_at", "ALTER TABLE users ADD COLUMN linkedin_session_updated_at TIMESTAMP"),
        ("users", "indeed_session_json", "ALTER TABLE users ADD COLUMN indeed_session_json TEXT"),
        ("users", "indeed_session_updated_at", "ALTER TABLE users ADD COLUMN indeed_session_updated_at TIMESTAMP"),
