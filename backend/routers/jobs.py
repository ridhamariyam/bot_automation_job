...
@router.post("")
def add_job(job: JobIn, token_email: str = Depends(require_auth)):
...
def update_status(job_id: str, body: StatusIn, token_email: str = Depends(require_auth)):
    with SessionLocal() as db:
...
def download_tailored_resume(job_id: str, token_email: str = Depends(require_auth)):
    """
